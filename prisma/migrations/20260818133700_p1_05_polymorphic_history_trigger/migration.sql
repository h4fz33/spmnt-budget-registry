-- The P1-04 immutability trigger is shared by tables with different row
-- shapes. Projecting OLD/NEW through JSONB avoids compiling School-only
-- fields while an AuthenticatedIdentity row is being updated.
