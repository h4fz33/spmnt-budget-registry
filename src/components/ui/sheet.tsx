...
type SheetContentProps = Omit<ComponentProps<typeof SheetPrimitive.Popup>, "className" | "children"> & {
  className?: string
  children?: ReactNode
...
function SheetOverlay({
  className,
  ...props
}: Omit<ComponentProps<typeof SheetPrimitive.Backdrop>, "className"> & { className?: string }) {
  return (
...
function SheetTitle({
  className,
  ...props
}: Omit<ComponentProps<typeof SheetPrimitive.Title>, "className"> & { className?: string }) {
  return (
...
function SheetDescription({
  className,
  ...props
}: Omit<ComponentProps<typeof SheetPrimitive.Description>, "className"> & { className?: string }) {
  return (
