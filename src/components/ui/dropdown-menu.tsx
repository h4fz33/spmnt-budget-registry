...
type DropdownMenuContentProps = Omit<ComponentProps<typeof MenuPrimitive.Popup>, "className" | "children"> &
  Pick<MenuPositionerProps, "align" | "alignOffset" | "side" | "sideOffset"> & {
    className?: string
    children?: ReactNode
  }

type DropdownMenuLabelProps = Omit<ComponentProps<typeof MenuPrimitive.GroupLabel>, "className"> & {
  className?: string
  inset?: boolean
}

type DropdownMenuItemProps = Omit<ComponentProps<typeof MenuPrimitive.Item>, "className"> & {
  className?: string
  inset?: boolean
  variant?: "default" | "destructive"
}

type DropdownMenuSubTriggerProps = Omit<ComponentProps<typeof MenuPrimitive.SubmenuTrigger>, "className"> & {
  className?: string
  inset?: boolean
}

type DropdownMenuCheckboxItemProps = Omit<ComponentProps<typeof MenuPrimitive.CheckboxItem>, "className" | "children"> & {
  className?: string
  children?: ReactNode
  inset?: boolean
}

type DropdownMenuRadioItemProps = Omit<ComponentProps<typeof MenuPrimitive.RadioItem>, "className" | "children"> & {
  className?: string
  children?: ReactNode
  inset?: boolean
}
...
function DropdownMenuSeparator({
  className,
  ...props
}: Omit<ComponentProps<typeof MenuPrimitive.Separator>, "className"> & { className?: string }) {
  return (
