...
- [ ] [BLOCKED] `P0-04` Approve roles, school/ESAO data boundaries, registration/membership authority, and segregation-of-duties rules. Dependencies: `P0-01`. All nine final BLK-003 decisions are applied. The task remains blocked by Policy Publisher current-status verification, approved Matrix designation/publication scope, remaining command-level `OPEN` values, and final matrix approval. Unresolved privileged commands are explicitly deferred and denied rather than assigned a permissive default. Done when every in-scope privileged command and membership action has an approved actor, approver, reviewer, and prohibited combination, and every unresolved command is explicitly deferred and denied rather than assigned a permissive default. Evidence: `docs/research/p0-04-authorization-research.md`, `docs/research/P0-04 — BLK-003 Resolution Record.md`, `docs/adr/0006-sesao-operational-policy-publication.md`, `docs/progress/sessions/2026-08-08_2230_codex_P0-01.md`, `docs/progress/sessions/2026-08-08_2250_codex_P0-04.md`, `docs/progress/sessions/2026-08-09_0856_codex_P0-04.md`, `docs/progress/sessions/2026-08-09_1150_codex_P0-04.md`, `docs/progress/sessions/2026-08-10_0009_codex_P0-04.md`, `docs/progress/sessions/2026-08-10_0148_codex_P0-04.md`.
