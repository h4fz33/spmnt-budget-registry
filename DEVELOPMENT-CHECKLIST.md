...
| `BLK-003` | `P0-04`, `P0-06`, `P0-10` | 2026-08-08 | SESAO Narathiwat Product Owner / accountable reviewer | Supply the remaining evidence/values needed to approve the final P0-04 role/capability matrix: Policy Publisher holder/alternate appointment evidence; Temporary Director Approval issuer/scope/duration/reviewer/evidence/SoD; correction reviewer; Daily Balance verifier; ESAO Reviewer scope; privileged-capability administration; and other command-level `OPEN` values. | Resolved at decision level 2026-08-09: all nine BLK-003 policy decisions are applied in the [resolution record](<docs/research/P0-04 — BLK-003 Resolution Record.md>). P0-04 remains blocked only for the listed evidence/`OPEN` values and final matrix approval. No names, issuers, reviewer capabilities, or approval authorities were invented. Evidence: `docs/research/p0-04-authorization-research.md`; `BLUEPRINT.md`; `reseach/CONTEXT.md`; `docs/adr/0003-nextauth-and-approved-registration.md`; `docs/adr/0006-sesao-operational-policy-publication.md`. |
...
- [ ] [BLOCKED] `P0-04` Approve roles, school/ESAO data boundaries, registration/membership authority, and segregation-of-duties rules. Dependencies: `P0-01`. All nine final BLK-003 decisions are applied. The task remains blocked by formal Policy Publisher holder/alternate appointment evidence, remaining command-level `OPEN` values, and final matrix approval. Unresolved privileged commands are explicitly deferred and denied rather than assigned a permissive default. Done when every in-scope privileged command and membership action has an approved actor, approver, reviewer, and prohibited combination, and every unresolved command is explicitly deferred and denied rather than assigned a permissive default. Evidence: `docs/research/p0-04-authorization-research.md`, `docs/research/P0-04 — BLK-003 Resolution Record.md`, `docs/adr/0006-sesao-operational-policy-publication.md`, `docs/progress/sessions/2026-08-08_2230_codex_P0-01.md`, `docs/progress/sessions/2026-08-08_2250_codex_P0-04.md`, `docs/progress/sessions/2026-08-09_0856_codex_P0-04.md`, `docs/progress/sessions/2026-08-09_1150_codex_P0-04.md`, `docs/progress/sessions/2026-08-10_0009_codex_P0-04.md`.
...
- [ ] [TODO] `P1-20` Implement evidence-backed Policy Publisher primary/alternate application and atomic replacement. Dependencies: `P1-08`, `P1-19`. Done when both subjects must be active SESAO Auditors; exactly one holder can publish; standby alternate cannot publish; System Admin can apply only exact external evidence with fresh re-authentication and no person/scope discretion; replacement atomically activates the alternate and removes the prior holder; missing evidence, generic grant, delegation, replay, and concurrent holders fail; and external authority plus technical executor are audited separately.
- [ ] [TODO] `P1-GATE` Approve Phase 1. Dependencies: `P1-01` through `P1-20`. Done when registration/approval, authenticated school isolation, evidence-backed ESAO Admin, SESAO Auditor, and Policy Publisher appointments, policy resolution, audit logging, idempotency, PostgreSQL migration/serializable transaction, build, and restore evidence pass.
