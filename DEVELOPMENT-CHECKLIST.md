...
- [ ] [TODO] `P4-12` Implement the SESAO School Financial Accounting Audit Assessment: scoped assignment, versioned criteria and workpapers, findings/corrective follow-up, policy-controlled score/result/ranking, per-school and ESAO reports, and immutable report history. Dependencies: `P0-11`, `P4-01`, `P4-07`, `P4-08`, `P1-08`. Done when an authorized auditor can complete and finalize a reproducible assessment without mutating canonical school records or exposing out-of-scope school results.
- [ ] [TODO] `P4-11` Complete report contract, print snapshot, export-boundary, self-assessment, audit-assessment, and ESAO end-to-end tests. Dependencies: `P4-02` through `P4-10`, `P4-12`. Done when official samples, assessment fixtures, and authorization fixtures pass.
- [ ] [TODO] `P4-GATE` Approve Phase 4. Dependencies: `P4-01` through `P4-12`. Done when the school and ESAO can complete an auditable fiscal reporting cycle and final accounting audit without spreadsheet repair.
