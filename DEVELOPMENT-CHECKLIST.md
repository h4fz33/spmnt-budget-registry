...
| `BLK-005` | `P0-03`, `P0-06`, `P0-09`, `P2-05` through `P2-11` | 2026-08-10 | SESAO Narathiwat Policy Publisher and Product Owner / accountable reviewer | Approve `P0-03-D01` through `P0-03-D10` and sign the complete 14-row Fund Flow/record matrix. | Open: exact partial behavior, electronic State Income remittance deadline, contract-security/withheld-tax model, Advance settlement control, transfer authorization, enabled fund subtypes, and conditional-flow applicability remain unsupported. Proposed fail-closed defaults and evidence: `docs/governance/p0-03-fund-flow-record-matrix.md`. |
...
- [ ] [BLOCKED] `P0-03` Approve the Fund Flow and record matrix, including cashbook inclusion, documents, approvals, partial settlements, and due dates. Dependencies: `P0-02`. The 14-row source-backed approval pack is complete, but `P0-03-D01` through `P0-03-D10` and Policy Publisher/accountable-reviewer sign-off remain `OPEN` under `BLK-005`; unsupported variants fail closed. Evidence: `docs/governance/p0-03-fund-flow-record-matrix.md`, `docs/progress/sessions/2026-08-10_1611_codex_P0-03.md`.
- [ ] [BLOCKED] `P0-04` Approve roles, school/ESAO data boundaries, registration/membership authority, and segregation-of-duties rules. Dependencies: `P0-01`. The canonical 33-row command Matrix includes the Product Owner-approved single-active end-to-end SESAO Auditor workflow. Conditions 10-11 remain blocked because Temporary Director Approval recipient eligibility and required subject evidence are `OPEN`; `AUTH-14`, `AUTH-15`, and every temporary variant are deferred and denied. Do not mark `[DONE]`. No application/RBAC changes are authorized by this reconciliation. Evidence: `docs/governance/p0-04-authorization-matrix.md`, `docs/research/P0-04 — BLK-003 Resolution Record.md`, `docs/adr/0012-single-active-end-to-end-sesao-auditor.md`, `docs/progress/sessions/2026-08-10_1532_codex_P0-04.md`.
...
- [ ] [TODO] `P2-08` Implement State Income receipt, Due-Date Control, approved full/partial Remittance behavior, and overdue state. Dependencies: `P2-06`, `P2-07`. Done when unsupported partial behavior fails closed and remittance cannot exceed or detach from its source receipt.
- [ ] [TODO] `P2-09` Implement the P0-03-approved contract-security/deposit receipt, due control, full/partial discharge behavior, and Lifecycle Child restrictions. Dependencies: `P2-06`, `P2-07`. Done when withheld tax is not conflated with contract security, unsupported partial behavior fails closed, and returns remain linked without exceeding the outstanding balance.
