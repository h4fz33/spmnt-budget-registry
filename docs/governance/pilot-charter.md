...
- `P0-04`: retain the Product Owner-approved Matrix and its operational evidence; before each Policy Publisher designation/publication, record the approved current-status check and scope evidence. Do not mark P0-04 done through this documentation reconciliation.
