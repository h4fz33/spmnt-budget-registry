...
- School financial-record boundaries remain unchanged. The active SESAO Auditor may access only the exact assigned Audit Assessment, School, period, and resolved policy/checklist evidence and gains no canonical record-mutation authority.
